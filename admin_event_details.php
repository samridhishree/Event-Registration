...
<?php
	...
	{
		$code = $i ;
		$query1 = "Select c.name AS name, sum(r.num_teams) AS sumt, sum(r.num_par) AS sump from college c, reg r where c.code = r.code AND r.e_num = '$e_num' AND c.code = '$code'" ;
	...
	echo '<p><a href="admin_event.php" class="links">Go to Event Admin Page</a></p>' ;
